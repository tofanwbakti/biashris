...
//============= PAGE DEPARTEMEN ==================//
		...
		public function getLinkDept($id)
		{
			...
			$query = $this->db->query("SELECT * FROM tb_departemen WHERE id_sub='$id' ORDER BY kode_dept ASC");
			return $query->result_array();
		}
...
//============= PAGE KARYAWAN ==================//
		...
		{
			$query = $this->db->query("SELECT * FROM tb_sbu WHERE grup='$id' ORDER BY kode ASC ");
			return $query->result_array();
		}
		...
		{
			$query = $this->db->query("SELECT * FROM tb_subunit WHERE kode='$id' ORDER BY sub ASC");
			return $query->result_array();
		}
		// Get Data Detail Jabatan
		public function getDetailJab($id)
		{
			$query = $this->db->query("SELECT * FROM tb_jabatan_detail WHERE id_jab='$id' AND aktif='Y' ORDER BY nama_jab ASC");
			return $query->result_array();
		}
