<!-- Content Header (Page header) -->
    <section class="content-header">
        <h1> <i class="icon fa fa-file-pdf-o text-blue"></i>
        Dokumen Kepegawaian
        <!-- <small>Medical Checkup</small> -->
        </h1>
        <ol class="breadcrumb">
        <li><a href="<?=site_url('Dashboard') ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="<?php foreach($rowdocemp as $data) site_url('C_Personal/kepeg/').encrypt_url($data['id_kar'] ) ?>"><i class="fa fa-user-md"></i> Detail Kepegawaian</a></li>
    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <a href="<?=site_url('C_personal/kepeg') ?>" class="btn btn-info btn-xs pull-right"> <i class="fa fa-undo"></i> Kembali</a>
                </h2>
            </div><!-- /.col -->
        </div>
        <!-- info row -->
