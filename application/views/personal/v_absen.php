            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <div class="form-inline">
                        <input type="password" name="rfid" id="rfid" class="form-control" style="width:72%;height:60px;font-size:30px" placeholder="Scan Kartu.." autofocus required autocomplete="new-password">
                    ...
                    <?php if(date('l')=="Friday"){ ?>
                        <small>Jam Kantor : 07:30 - 17:30 WIB </small> <small class="pull-right">IP Address : <?=$this->input->ip_address();?></small>
                    <?php }else {?> <small>Jam Kantor : 08:00 - 17:00 WIB </small> <small class="pull-right">IP Address : <?=$this->input->ip_address();?></small> <?php } ?>
                </div>
            </div>                
