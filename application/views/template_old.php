...
<html>
    <head>
		...
		<!--===============================================================================================-->	
		<link rel="icon" type="image/png" href="<?php echo base_url();?>assets/images/icons/bmgico.png"/>
        <!-- Bootstrap 3.3.2 -->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">                                
                                ...
                                <span class="hidden-xs "><?= $this->fungsi->user_login()->nickname ?> <span class="caret"></span></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
...
<!-- MENU Untuk HRD -->
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            ...
            <!--<b>Version</b> 20.01.1 -->  <!-- [Tahun].[Bulan].[Upgrade ke]  -->
            <b>Version</b> 20.08.1  <!-- [Tahun].[Bulan].[Upgrade ke]  -->
        </div>
