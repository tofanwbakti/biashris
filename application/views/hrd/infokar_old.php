    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="box box-danger">
                ...
                <img style="width:150px;height:relative" src="<?php echo base_url();?>uploads/image/<?php foreach($rowkar as $data) echo $data['foto']; ?>" class="img-thumnail"  alt="User Image" />
                ...
                <div class="modal-body">
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="form-group" style="margin-top:15px">
                                ...
                                <div class="input-group"> 
                                    <select class="form-control" name="level" id="level" required>
                                        <?php foreach ($rowkar as $data) ?>
                                        <option selected value="<?=$data['id_jab']?>"><?= $data['nama_jab'] ?></option>
                            ...
                            <div class="form-group" style="margin-top:15px">
                                <label for="grup">Grup Perusahaan</label><small class="text-danger"> *</small> 
                                <div class="input-group"> 
                                    <select class="form-control" name="grup" id="grup" required>
                                        <?php foreach ($rowkar as $data) { 
                                            echo "<option value=$data[id_grup]>$data[kode_grup]</option>"; 
                                            } 
                                        ?>
                            ...
                            <div class="form-group" style="margin-top:15px">
                                <label for="subunit">Sub Unit</label><small class="text-danger"> *</small> 
                                <div class="input-group"> 
                                    <select class="subunit form-control" name="subunit" id="subunit" required>
                                        <?php foreach ($rowkar as $data) { ?>
                                        <option selected><?= $data['sub_unt'] ?></option>
                                        <?php } ?>
                                    </select>
                                    <div class="input-group-addon">
                                        <i class="fa fa-tag"></i>
