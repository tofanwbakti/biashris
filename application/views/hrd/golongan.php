...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url();?>Hrd/golongan"><i class="fa fa-circle-o"></i> Golongan</a></li>
</section>
<!-- Main content -->
...
<!-- Default box -->
    <div class="box">
        ...
        <div class="box-body">
            Berikut Daftar Golongan di Bias Mandiri Group
        </div><!-- /.box-body -->
...
<div class="row">
    <div class="col-md-4">
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Daftar Level Golongan</h3>
                ...
                <div class="collapse" id="tambah" style="margin-top:15px">
                    <form action="<?=site_url('Hrd/addJab') ?>" method="post" class="form-inline">
                        ...
                        <div class="form-group">
                            <input type="text" name="namajab" class="form-control" style="width:210px;height:30px;margin-left:3px" placeholder="Nama Golongan.." onkeyup="this.value = this.value.toUpperCase()" required>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <a href="#" id="gantiLevel" data-toggle="modal" data-target="#editLevel" data-id="<?=$data['id_jab'] ?>" data-nama="<?=$data['nama_jab'] ?>"><i class="icon fa fa-edit text-danger"></i></a>
    ...
    <div class="col-md-8">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Daftar Detail Golongan Karyawan </h3>
                <div class="pull-right">
                ...
                <div class="table-responsive no-padding">
                    <table class="table table-hover" id="tablehistory">
                        ...
                        <tr>
                            ...
                            <td><?=$data['sbu'] ?></td>
                            <td>
                            <a href="#" id="updateJail" data-toggle="modal" data-target="#editJail" data-id="<?=$data['id_jail'] ?>" data-kode="<?=$data['kode_jail'] ?>" data-nama="<?=$data['nama_jail'] ?>" data-jab="<?=$data['id_jab'] ?>" data-sbu="<?=$data['sbu'] ?>" ><i class="icon fa fa-edit text-info"></i></a>
            ...
            <form role="form" action="<?=site_url('Hrd/updateJab')?>" method="POST">
                <div class="modal-body" id="ubahLvl">                
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="namajab" >Nama Golongan</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="namajab" name="namajab" placeholder="Nama Golongan.." onkeyup="this.value = this.value.toUpperCase()" required>
                                    <div class="input-group-addon">
                                    <i class="fa fa-tags"></i>
                                    </div>
                                </div>
    ...
    <div id= "tambahJail" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <form role="form" action="<?= site_url('Hrd/addJail') ?>" method="POST">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"> <i class="fa fa-tags text-primary"></i>  Tambah Detail Golongan Karyawan</h4>
                </div>
                
                <div class="modal-body">                
                        <div class="box-body">
                            <div class="form-group">
                                <label for="subkode">Kode Golongan</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label for="namajail" >Deskripsi Detail Golongan</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="namajail" name="namajail" placeholder="Deskripsi Detail Golongan.." onkeyup="this.value = this.value.toUpperCase()" required>
                                    <div class="input-group-addon">
                                    <i class="fa fa-tags"></i>
                                    </div>
                                </div>
    ...
    <div id= "editJail" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"> <i class="fa fa-tags text-primary"></i>  Edit Detail Golongan Karyawan</h4>
                </div>
            <form role="form" action="<?=site_url('Hrd/updateJail')?>" method="POST">
                <div class="modal-body" id="ubahJail">                
                        <div class="box-body">
                            <div class="form-group">
                                <label for="kodejail">Kode Golongan</label>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <label for="namajail" >Deskripsi Detail Golongan</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="namajail" name="namajail" placeholder="Deskripsi Sub Unit.." required>
                                    <div class="input-group-addon">
                                    <i class="fa fa-tags"></i>
                                    </div>
                                </div>
