...
function kontrakxls(){
            window.location.assign('<?=base_url('Hrd/excelKontrak') ?>');            
        }

function kontrakEOC(){
    window.location.assign('<?=base_url('Hrd/excelKontrakEoc') ?>');
}
...
<section class="content-header">
    <h1> <i class="icon fa fa-archive"></i>
        Kontrak Karyawan
    ...
    <div class="row">
                        ...
                        <table class="table table-hover" id="tablehistory">
                            ...
                            ?>
                                <tr <?= $data['periodepkwt'] == "II" ? "class='warning'" : null ?>>
                                    ...
                                    <td><?=$data['nickname'] ?></td>
                                    <td><?=$data['stat_kar'] == "T" ? "Tetap" : "Kontrak" ?></td>
                                    <td><?=$data['periodepkwt'] ?></td>
        ...
        <div class="col-md-4">
            <div class="box box-danger">
                <div class="box-header">
                    <h3 class="box-title">Daftar EOC</h3>
    ...
    <div id= "modalDetail" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="reset" class="btn btn-default pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Tutup</button>
                    <button type="submit" name="update" id="btnUpdate" class="btn btn-success pull-right"><i class="fa fa-check" ></i> Update</button>
                </div>
                </form>
            </div>
            ...
            <script type="text/javascript" >                
                $(document).on("click","#detailEoc",function(){
                    ...
                    if($(this).data('periode')=="I"){
                        $("#rowPeriode").html('<select name="periode" class="form-control"><option class="label-success" value="I" selected disabled>Ke - I</option><option value="II">Ke - II</option></select><input type="hidden" name="tipekon" value="R" class="form-control" style="height:20px" readonly>');
                        ...
                        //         }
                        //     });                            
                        //     $('#tglawal,#tglakhir').disable(false); //enable button update dengan jquery
                        // });
                ...
                $('.eoc-detail').on("click", function(){
                    ...
                    if($(this).data('statkar')=="T"){isi="Tetap";
                        ...
                        //     $('button').disable(true); //enable button update dengan jquery
                        // });
                    };
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group" style="margin-top:10px">
                                ...
                                <div class="form-inline">
                                    ...
                                    <select class="subunitOld form-control" id="subunitOld" name="subunitOld" required style="width:350px;margin-left:5px">
                                        <option selected disabled>Pilih Satu..</option>
                                    </select>
                                    <small class="text-muted" id="text_subOld" style="margin-left:200px"><a href="<?=site_url('Hrd/sbu')?>">Klik disini jika data kosong/tidak ada</a></small>
                                </div>                                    
                            </div>
                            <div class="form-group" style="margin-top:10px">
